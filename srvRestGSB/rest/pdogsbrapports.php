...
class PdoGsbRapports{   		
      ...
      private static $serveur='mysql:host=localhost'; // pour mysql
...
*/
	...
	public function verifierSecretaire($login, $mdpHache){
        ...
        public function getLesRapportsEntreDeuxDates( $dateDebut, $dateFin){ /* à tester*/
                $req = " select distinct rapport.id as id , medecin.nom as nomMedecin, medecin.prenom as prenomMedecin,rapport.date as date, ";
        ...
        public function getLesRapportsParVisiteur($idVisiteur){
                ...
                $req = "select rapport.id as id,distinct rapport.date as date, rapport.motif as motif, ";
